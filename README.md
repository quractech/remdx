...
2. Connect REMDx to you PC with a USB cable that is capable of data transfer. <img src="stm32cubeprogrammer.PNG" width=50%>
...
4. Select the COMPORT, find it under Device Manager in windows<br>
        <img src="comport.PNG" width=50%>
5. Select the BAUD RATE 115200 and connect, now you should see a contineous data stream as show in the picture below.<br>
